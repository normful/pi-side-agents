...
- Run in parent agent: `/load-side-agents-tools`. It registers these tools used by parent agents: `sideagent-start`, `sideagent-check`, `sideagent-wait-any`, `sideagent-send`
...
- Ask parent agent to use one of `sideagent-check`, `sideagent-wait-any`, `sideagent-send` to manage the child agents.
